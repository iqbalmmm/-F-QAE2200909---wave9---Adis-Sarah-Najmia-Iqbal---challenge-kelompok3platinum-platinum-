...
WebUI.callTestCase(findTestCase('pages/Delete Item/Daftar Jual Saya'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('pages/Delete Item/Click Item to Delete'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('pages/Delete Item/Delete'), [:], FailureHandling.STOP_ON_FAILURE)
