...
WebUI.callTestCase(findTestCase('pages/QA-Audyna/Add Items - Audyna/Click Item'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('pages/QA-Audyna/Add Items - Audyna/Delete Items'), [:], FailureHandling.STOP_ON_FAILURE)
