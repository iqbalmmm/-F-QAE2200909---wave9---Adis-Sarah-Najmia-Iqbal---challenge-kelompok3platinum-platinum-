...
WebUI.callTestCase(findTestCase('pages/User Login/Input Email'), [('email') : GlobalVariable.wrongemail], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('pages/User Login/Input Password'), [('password') : GlobalVariable.wrongpassword], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('pages/User Login/Click Login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('pages/User Login/Verify Content (Negative)'), [:], FailureHandling.STOP_ON_FAILURE)
