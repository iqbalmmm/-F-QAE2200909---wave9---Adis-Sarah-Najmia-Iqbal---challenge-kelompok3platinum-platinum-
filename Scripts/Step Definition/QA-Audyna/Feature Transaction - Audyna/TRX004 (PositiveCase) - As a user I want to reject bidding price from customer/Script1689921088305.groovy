...
WebUI.click(findTestObject('QA-Audyna/Transaction - Audyna/Notif Product 3'))

WebUI.callTestCase(findTestCase('pages/QA-Audyna/Transaction - Audyna/Button for Reject Bidding Product 3'), [:], FailureHandling.OPTIONAL)
