...
WebUI.click(findTestObject('QA-Audyna/Transaction - Audyna/Notif for Product 5'))

WebUI.callTestCase(findTestCase('pages/QA-Audyna/Transaction - Audyna/Button for Accept Bidding'), [:], FailureHandling.OPTIONAL)

WebUI.callTestCase(findTestCase('pages/QA-Audyna/Transaction - Audyna/Button for Status Product Product 5'), [:], FailureHandling.OPTIONAL)
